...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DefaultTrackableEventHandler_OnDestroy_m5E62349849150C8A7D3805322622A958505710AC (DefaultTrackableEventHandler_t6997E0A19AC0FABC165FB7264F57DF2EDF4E8022 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		TrackableBehaviour_t579D75AAFEF7B2D69F4B68931D5A58074E80A7E4 * L_2 = __this->get_mTrackableBehaviour_7();
		Action_1_tC1665C34A5AFA06FE50136154D05E87F6E61011C * L_3 = (Action_1_tC1665C34A5AFA06FE50136154D05E87F6E61011C *)il2cpp_codegen_object_new(Action_1_tC1665C34A5AFA06FE50136154D05E87F6E61011C_il2cpp_TypeInfo_var);
		Action_1__ctor_m6239C5C309E8A57721CD442304F25477703B572C(L_3, __this, (intptr_t)((intptr_t)DefaultTrackableEventHandler_OnTrackableStatusChanged_mD0151888A5964EC20FE420CBFDD44825E8D41397_RuntimeMethod_var), /*hidden argument*/Action_1__ctor_m6239C5C309E8A57721CD442304F25477703B572C_RuntimeMethod_var);
		NullCheck(L_2);
		TrackableBehaviour_UnregisterOnTrackableStatusChanged_mB30D3A04D24411E61AE13AE194407E06F9A5461B(L_2, L_3, /*hidden argument*/NULL);
	}
...
IL_0024:
	{
		...
		bool L_5 = DefaultTrackableEventHandler_ShouldBeRendered_mC843946809525636F02A702A00348AF8E505E016(__this, L_4, /*hidden argument*/NULL);
		if (!L_5)
		{
			goto IL_0048;
		}
	}
	{
		...
		bool L_7 = DefaultTrackableEventHandler_ShouldBeRendered_mC843946809525636F02A702A00348AF8E505E016(__this, L_6, /*hidden argument*/NULL);
		if (L_7)
		{
			goto IL_0048;
		}
...
IL_0048:
	...
	}
	{
		...
		bool L_10 = DefaultTrackableEventHandler_ShouldBeRendered_mC843946809525636F02A702A00348AF8E505E016(__this, L_9, /*hidden argument*/NULL);
		if (L_10)
		{
			goto IL_0064;
		}
...
IL_0008:
	{
		...
		UnityRuntimeCompiledFacade_set_Instance_mAD789CACB83D18D963C131AFDE2A29DE7B3D5E76_inline(L_2, /*hidden argument*/NULL);
		// }
		return;
	}
}
